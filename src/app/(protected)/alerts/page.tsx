        ...
        <div className="bg-card rounded-2xl p-5 card-shadow border border-border mb-4 animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`w-12 h-7 rounded-full transition-colors relative ${whatsappOn ? "bg-success" : "bg-muted"}`}
            >
              <div className={`w-5 h-5 bg-card rounded-full absolute top-1 transition-all card-shadow ${whatsappOn ? "left-6" : "left-1"}`} />
            </button>
          </div>
        </div>
