              ...
              <div key={i} className="flex-1 flex flex-col items-center gap-1">
                ...
                <div
                  className={`w-full rounded-lg transition-all ${
                    i === values.length - 1 ? "bg-primary" : "bg-primary/15"
                  }`}
                  style={{ height: `${v > 0 ? (v / maxVal) * 100 : 4}%`, minHeight: 4 }}
                />
        ...
        <div className="space-y-3 animate-fade-in-up" style={{ animationDelay: '0.15s' }}>
          ...
          <div className="bg-warning/10 border border-warning/20 rounded-xl p-4 flex items-start gap-3">
            ...
            <p className="text-sm text-foreground">
              Você está gastando <strong>mais</strong> com manutenção este mês comparado à média.
            </p>
          </div>
          ...
          <div className="bg-success/10 border border-success/20 rounded-xl p-4 flex items-start gap-3">
            ...
            <p className="text-sm text-foreground">
              Suas manutenções preventivas economizaram ~<strong>R$ 600</strong> este ano.
            </p>
          </div>
        </div>
      </div>
