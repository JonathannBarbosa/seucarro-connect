      ...
      <div ref={reportRef} className="px-5 py-6 pb-10 space-y-5 max-w-lg mx-auto">
        ...
        <div className="bg-card rounded-2xl p-5 card-shadow">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">Baseado no histórico de manutenções</p>
            </div>
            <div className="text-right">
              <span className="text-3xl font-extrabold text-accent">{reliabilityScore}</span>
          ...
          <div className="mt-4 grid grid-cols-2 gap-2">
            <div className="flex items-center gap-2 bg-accent/5 rounded-lg px-3 py-2">
              ...
              <span className="text-xs text-foreground font-medium">Manutenções em dia</span>
            </div>
            <div className="flex items-center gap-2 bg-accent/5 rounded-lg px-3 py-2">
              <CheckCircle className="w-3.5 h-3.5 text-accent" />
              <span className="text-xs text-foreground font-medium">Revisões regulares</span>
            </div>
            <div className="flex items-center gap-2 bg-accent/5 rounded-lg px-3 py-2">
              <CheckCircle className="w-3.5 h-3.5 text-accent" />
              <span className="text-xs text-foreground font-medium">Pneus novos</span>
            </div>
            <div className="flex items-center gap-2 bg-accent/5 rounded-lg px-3 py-2">
              <CheckCircle className="w-3.5 h-3.5 text-accent" />
              <span className="text-xs text-foreground font-medium">Óleo em dia</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-card rounded-2xl p-5 card-shadow">
          ...
          <div className="space-y-3">
            {[
              { label: "Fluidos", value: "R$ 530", pct: 14, color: "bg-primary" },
              { label: "Freios", value: "R$ 520", pct: 14, color: "bg-warning" },
              { label: "Pneus", value: "R$ 1.800", pct: 47, color: "bg-danger" },
              { label: "Revisão", value: "R$ 950", pct: 25, color: "bg-muted-foreground" },
            ].map((cat) => (
              <div key={cat.label}>
